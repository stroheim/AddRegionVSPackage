...
namespace VSPackage1_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        public void InitializeMenuCommand()
        {
            ...
            CommandID menuCommandID = new CommandID(Company.VSPackage1.GuidList.guidVSPackage1CmdSet, (int)Company.VSPackage1.PkgCmdIDList.cmdidMyCommand);
